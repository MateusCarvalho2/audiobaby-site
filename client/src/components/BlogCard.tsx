...
export default function BlogCard({ post, featured = false }: BlogCardProps) {
  return (
    <Link
      href={`/blog/${post.slug}`}
      className={`motion-card reveal group block overflow-hidden border border-[#94B1DA]/16 bg-white ${
    ...
    >
      ...
      <div className={featured ? "p-7 md:p-9" : "p-5"}>
        ...
        <span className="mt-6 inline-flex items-center gap-2 font-nunito text-sm font-900 uppercase tracking-[0.12em] text-[#6B90C4]">
          Ler artigo
          <ArrowRight
            size={16}
