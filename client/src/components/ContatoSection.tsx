 ...
 * Design: CTA final com fundo azul, formulário simples, footer com logo e links
 */
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-lato text-[#94B1DA] text-sm">(00) 00000-0000</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#94B1DA]/20 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="font-lato text-[#94B1DA] text-sm">Rua Exemplo, 123 — Cidade, Estado</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#94B1DA]/20 flex items-center justify-center">
            ...
            <div className="reveal-right">
              <div className="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                <a
                  ...
                  className="btn-premium w-full flex items-center justify-center gap-3 bg-[#25D366] text-white font-nunito font-800 text-base px-6 py-4 rounded-2xl mb-4"
                >
                ...
                <a
                  ...
                  className="interactive-hover w-full flex items-center justify-center gap-3 bg-[#EEF4FB] text-[#6B90C4] font-nunito font-700 text-base px-6 py-4 rounded-2xl"
                >
                  <Phone size={18} />
                  (00) 00000-0000
                </a>
                ...
                <div className="mt-6 pt-6 border-t border-[#94B1DA]/10">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="font-lato text-xs text-[#718096] leading-relaxed">
                      Atendemos convênios e particulares. Entre em contato para verificar sua cobertura e disponibilidade de agenda.
                    </p>
                  </div>
                </div>
              </div>
