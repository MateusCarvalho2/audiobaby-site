      ...
      <div className="container">
        ...
        <div className="text-center mb-14 reveal-clip">
          ...
          <p className="font-lato text-lg text-[#718096] max-w-2xl mx-auto">
            Cada detalhe do nosso espaço e da nossa equipe foi pensado para que
            você e seu filho se sintam seguros, acolhidos e bem cuidados.
          </p>
        </div>
            ...
            {diferenciais.slice(0, 3).map((d, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-nunito font-800 text-[#2C3E50] text-base mb-1 transition-colors duration-300 group-hover:text-[#6B90C4]">
                      {d.title}
                    </h3>
          ...
          <div className="reveal-blur flex flex-col gap-4">
            <div className="relative rounded-3xl overflow-hidden shadow-xl h-56 group">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="font-nunito font-800 text-white text-sm">
                  Ambiente acolhedor
                </p>
                <p className="font-lato text-xs text-white/80">
                  Projetado para bebês e famílias
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#94B1DA] rounded-3xl p-6 text-center shadow-md border border-[#94B1DA]/10 hover:border-[#94B1DA]/30 transition-all duration-500">
              ...
              />
              <p className="font-nunito font-900 text-white text-2xl mb-1">
                Especialistas
              </p>
              <p className="font-nunito font-700 text-white/80 text-sm">
                em audição infantil
              </p>
              <div className="mt-4 pt-4 border-t border-white/20 grid grid-cols-2 gap-3">
                <div>
                  <p className="font-nunito font-900 text-[#F4C62F] text-xl animate-pulse">
                    100%
                  </p>
                  <p className="font-lato text-xs text-white/80">
                    Foco em crianças
                ...
                <div>
                  ...
                  <p className="font-nunito font-900 text-[#F4C62F] text-xl">
                    Sedação
                  </p>
                  <p className="font-lato text-xs text-white/80">
                    quando indicada
